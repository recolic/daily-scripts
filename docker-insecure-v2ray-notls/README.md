...
this is for port 80 without TLS. designed for cathay pacific shit.
...
```
sudo docker run -d --restart always --log-opt max-size=1M --name rv -p 443:443 recolic/insecure-v2ray:notls
```
