...
complete -c copilot -n '__fish_seen_subcommand_from login' -l device-code -f -d 'Authenticate using the OAuth device code flow (default in remote or headless environments)'
complete -c copilot -n '__fish_seen_subcommand_from login' -l web-flow -f -d 'Authenticate using the browser (web) flow (default on local desktops)'
...
complete -c copilot -n '__fish_seen_subcommand_from mcp; and __fish_seen_subcommand_from add' -l transport -r -f -a 'stdio http sse'
complete -c copilot -n '__fish_seen_subcommand_from mcp; and __fish_seen_subcommand_from add' -l transport -r -f -d 'Server transport'
...
complete -c copilot -n '__fish_seen_subcommand_from plugins; and __fish_seen_subcommand_from install' -l scope -r -f -a 'user project'
complete -c copilot -n '__fish_seen_subcommand_from plugins; and __fish_seen_subcommand_from install' -l scope -r -f -d 'Install target for a file/URL --skill: user (default) or project'
...
complete -c copilot -n '__fish_seen_subcommand_from plugins; and __fish_seen_subcommand_from add' -l scope -r -f -a 'user project'
complete -c copilot -n '__fish_seen_subcommand_from plugins; and __fish_seen_subcommand_from add' -l scope -r -f -d 'Install target for a file/URL --skill: user (default) or project'
