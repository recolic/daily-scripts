...
lc_init () {
    ...
    pacman -Sy --needed --noconfirm base-devel telegram-desktop docker shadowsocks-rust dos2unix v2ray proxychains xclip adobe-source-han-sans-cn-fonts      pcsclite ccid     ttf-fira-code  nfs-utils gnome-tweaks fcitx5-im man-db man-pages  kolourpaint breeze xorg-xrandr
    pacman -Sy --needed --noconfirm uv python-pip
